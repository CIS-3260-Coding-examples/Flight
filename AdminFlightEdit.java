...
public static void addbuttonClicked() throws Exception {
	...
	String a = (DatabaseMethods.returnFlightIdFormat(i), DatabaseMethods.returnFlightDateFormat(i), DatabaseMethods.returnFlightCityFormat(i),
	...
	flight.setFlightId(flightIdInput.getText());
